                                            ...
                                            <tr style="border-collapse:collapse">
                                                <td align="left" style="padding:0;Margin:0;width:560px">
                                                    <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                        <tr style="border-collapse:collapse">
                                                            <td align="center" style="padding:0;Margin:0;padding-top:20px;font-size:0"><img class="adapt-img" src="https://api-laravel.aplica.io/images/brand/Logo-02.png" alt style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;width:300px; height:200px;"></td>
                                                        </tr>
                                                    </table></td>
                                            </tr>
                                            <tr style="border-collapse:collapse">
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                        <tr style="border-collapse:collapse">
                                                            <td align="center" style="padding:0;Margin:0;padding-bottom:5px;padding-top:10px"><h2 style="Margin:0;line-height:30px;mso-line-height-rule:exactly;font-family:Poppins, sans-serif;font-size:25px;font-style:normal;font-weight:bold;color:#00413F">
                                                                ¡Te hemos invitado a unirte!</h2></td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse">
                                                            <td align="center" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:15px;font-family:tahoma, verdana, segoe, sans-serif;line-height:23px;color:#333333">
                                                                <p>
                                                                    <a href="https://aplica.io" target="_blank">APLICA.IO</a> te invita gratamente a registrarte como administrador para que te familiarices con este sistema, el cual te garantizará una mayor comodidad a la hora de llevar una adecuada gestión de cuentas y finanzas en tu  condominio o todos aquellos condominios que estén bajo tu responsabilidad.
                                                                </p>
                                                                <br><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:15px;font-family:tahoma, verdana, segoe, sans-serif;line-height:23px;color:#333333">
                                                                    Nosotros nos caracterizamos por ser un sistema puntual y accesible desde cualquier lado o dispositivo, es lo que todo administrador necesita para su labor diaria. Es confiable, seguro, rápido y está programado con todas las herramientas e información que probablemente no encontrarás en otra aplicación. 
                                                                </p><br>
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:15px;font-family:tahoma, verdana, segoe, sans-serif;line-height:23px;color:#333333">
                                                                    Puedes registrarte de manera gratuita desde nuestra página web:  <a href="{{ $url }}" target="_blank">aplica.io</a> ¡Te estaremos esperando con muchas ansias para ayudarte y facilitarte tu día a día con este actualizado sistema!
                                                                </p>
                                                            </td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse">
                                                            <td align="center" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px">
                                                                ...
                                                                <span class="msohide es-button-border" style="border-style:solid;border-color:#00C4C6;background:#00C4C6;border-width:0px;display:inline-block;border-radius:5px;width:auto;mso-hide:all">
                                        ...
                                        <table class="es-right" cellspacing="0" cellpadding="0" align="right" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;float:right">
                                            <tr style="border-collapse:collapse">
                                                <td align="left" style="padding:0;Margin:0;width:270px">
                                                    <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                        <tr style="border-collapse:collapse">
                                                            <td align="right" class="es-m-txt-c" style="padding:0;Margin:0"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:tahoma, verdana, segoe, sans-serif;line-height:21px;color:#FFFFFF">© All Rights Reserved, 2021</p></td>
                                                        </tr>
                                                    </table></td>
                                            </tr>
                                        </table>
